...
log_dir = "ppo_baseline/"
tensorboard_log = log_dir + "board/"
env_id = 'gym_seir:seir-v0'
n_timesteps = int(1e5)
N = 10000 # total number of samples generated to plot
...
print("Finished Saved the data at: %s".format(file_name))
...
def pair_plot(df, pal):
    ...
    plt.savefig(log_dir + "scatter_bs.pdf", bbox_inches='tight')
